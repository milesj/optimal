 ...
 */
export function and<T>(state: SchemaState<T>, ...keys: string[]): void | CriteriaValidator<T> {
  if (__DEV__) {
 ...
 */
export function only<T>(state: SchemaState<T>): void | CriteriaValidator<T> {
  if (__DEV__) {
 ...
 */
export function or<T>(state: SchemaState<T>, ...keys: string[]): void | CriteriaValidator<T> {
  if (__DEV__) {
 ...
 */
export function xor<T>(state: SchemaState<T>, ...keys: string[]): void | CriteriaValidator<T> {
  if (__DEV__) {
