 ...
 */
export function float(): void | CriteriaValidator<number> {
  if (__DEV__) {
    return (value, path) => {
 ...
 */
export function gte(state: SchemaState<number>, min: number): void | CriteriaValidator<number> {
 ...
 */
export function int(): void | CriteriaValidator<number> {
  if (__DEV__) {
    return (value, path) => {
 ...
 */
export function lte(state: SchemaState<number>, max: number): void | CriteriaValidator<number> {
 ...
 */
export function negative(): void | CriteriaValidator<number> {
  if (__DEV__) {
    return (value, path) => {
 ...
 */
export function positive(): void | CriteriaValidator<number> {
  if (__DEV__) {
    return (value, path) => {
